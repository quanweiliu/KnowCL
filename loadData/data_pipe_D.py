...
def get_data(args):
    ...
    data, train_gt = data_reader.load_data(args.dataset_name, path_data=args.path_data, type_data="TRLabel")
    data, test_gt = data_reader.load_data(args.dataset_name, path_data=args.path_data, type_data="TSLabel")
    ...
    print(img.shape, img1.shape, img2.shape, data_gt.shape)
    train_gt = np.pad(train_gt, pad_width=pad_width, mode="constant", constant_values=(0))
    print(img.shape, img1.shape, img2.shape, train_gt.shape)
    test_gt = np.pad(test_gt, pad_width=pad_width, mode="constant", constant_values=(0))
    print(img.shape, img1.shape, img2.shape, test_gt.shape)
